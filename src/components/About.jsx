    ...
    <div class="about-section">
      <div class="intro-container" id="intro-container">
        ...
        <p>
          ...
          <RoughNotation type="highlight" show={true} color="#90BAAD95" iterations={1}>React</RoughNotation>, <RoughNotation type="highlight" show={true} color="#FFB10070" iterations={1}>JavaScript</RoughNotation>
          , and <RoughNotation type="highlight" show={true} color="#FFB10070" iterations={1}>CSS</RoughNotation>. I became fascinated with computer
        ...
        <p>
          ...
          determined to see things through and <RoughNotation type="highlight" show={true} color="#90BAAD95" iterations={1}>enjoy lifting teams to success </RoughNotation>with my positivity and kindness.
        </p>
        <p>
          I'm currently looking for a new role as a developer. <RoughNotation type="circle" show={true} color="rgb(244, 214, 244)" iterations={10}>So let's talk!</RoughNotation>
        </p>
        <button
